...
func (s *DocumentService) UpdateTitle(documentID, userID, title string) error {
...
func (s *DocumentService) CreateShareToken(documentID, userID string) (string, error) {
...
func (s *DocumentService) FindFromSharingToken(tokenString string) (*models.Document, error) {
