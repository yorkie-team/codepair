...
const (
	SettingsService_GetSettings_FullMethodName = "/codepair.v1.SettingsService/GetSettings"
)
...
var SettingsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "codepair.v1.SettingsService",
	...
	Metadata: "codepair/v1/settings.proto",
}
